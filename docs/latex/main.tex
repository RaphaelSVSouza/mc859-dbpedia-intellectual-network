...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{grafo_rede_intelectual.png}
  \caption{Núcleo estrutural obtido a partir dos vértices de maior grau. O tamanho dos vértices é proporcional ao grau total e as cores representam comunidades identificadas por Louvain.}
  \label{fig:nucleo}
\end{figure}
